#!/usr/bin/env python3
"""
Script de prueba: Procesar exactamente 50 facturas desde Drive
...
def main():
    print("="*70)
    print("🧪 PRUEBA: Procesamiento de 50 Facturas")
    print("="*70)
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix='test_50_facturas_'))
